...
return [
    ...
    'wallet_requests_fetched_successfully' => 'Wallet requests fetched successfully.',
    'settleable_orders_fetched_successfully' => 'Settleable orders fetched successfully.',
    'wallet_request_created_successfully' => 'Wallet request submitted successfully.',
    ...
    'wallet_request_already_processed' => 'This wallet request has already been processed.',
    'invalid_wallet_request_status' => 'Invalid wallet request status.',
    'insufficient_wallet_balance' => 'Insufficient wallet balance.',
    'withdrawal_amount_must_be_positive' => 'Withdrawal amount must be greater than zero.',
    'pending_withdrawal_exists' => 'You already have a pending withdrawal request.',
    'order_must_be_completed_for_settlement' => 'Order must be completed before settlement.',
    'order_is_not_cod' => 'This order is not a cash on delivery order.',
    'order_already_settled' => 'This order has already been settled.',
    'settlement_request_already_exists' => 'A settlement request already exists for this order.',
