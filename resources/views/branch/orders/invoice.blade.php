    ...
    <table>
        ...
        <tbody>
            <tr>
                @if ($order->billingAddress)
                    <td>
                        <div class="rtl"><strong>{{ arabic_pdf($order->billingAddress->name) }}</strong></div>
                        <div class="rtl">{{ arabic_pdf($order->billingAddress->address) }}</div>
                        <div class="rtl">{{ arabic_pdf($order->billingAddress->city) }}, {{ arabic_pdf($order->billingAddress->state) }}</div>
                        <div>{{ $order->billingAddress->phone }}</div>
                    </td>
                @endif
                @if ($order->shippingAddress)
                    <td>
                        <div class="rtl"><strong>{{ arabic_pdf($order->shippingAddress->name) }}</strong></div>
                        <div class="rtl">{{ arabic_pdf($order->shippingAddress->address) }}</div>
                        <div class="rtl">{{ arabic_pdf($order->shippingAddress->city) }}, {{ arabic_pdf($order->shippingAddress->state) }}</div>
                ...
                @if ($order->branch)
                    ...
                    <td>
                        <div class="rtl"><strong>{{ arabic_pdf($order->branch->name) }}</strong></div>
                        @if ($order->branch->address ?? false)
                            <div class="rtl">{{ arabic_pdf($order->branch->address) }}</div>
                        @endif
                    </td>
