                    ...
                    <div id="productWizard">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="step-2" class="tab-pane" role="tabpanel">
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <div class="alert alert-info">
                                                    <i class="fa fa-info-circle"></i> Select variant options above, then click "Generate Combinations" to create product variants.
                                                </div>
                                                <div id="product-variants-container">
                                                    <table class="table table-bordered" id="product-variants-table" style="display: none;">
                                                <thead>
                                                    <tr>
                                                                <th>Variant Name</th>
                                                                <th>SKU</th>
                                ...
                                <!-- Branch Stock Section (For Both Simple and Variable Products) -->
                                <div class="card mb-4" id="product-branch-stocks-section">
                                    <div class="card-header">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function toggleProductTypeFields() {
                ...
                if (productType === 'simple') {
                    ...
                    $('#product-branch-stocks-section').hide(); // Hide branch stocks for variable products (variants have their own)
            ...
            $('#productWizardForm').on('submit', function(e) {
                ...
                if (productType === 'simple') {
                    ...
                    if (!price || parseFloat(price) < 0) {
                        e.preventDefault();
                        alert('Please enter a valid price for the simple product.');
        ...
        $('#generate-variants-btn').on('click', function() {
            ...
            $('#product-variants-container .alert').html(
                `<i class="fa fa-check-circle"></i> Generated ${combinations.length} variant combination(s). Fill in the details below.`
