        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                ...
                <div class="card border-0 shadow-sm mb-4 rounded-4 bg-white" style="background: #ffffff !important; border-color: transparent !important;">
                    ...
                    <div class="card-body">
                        @php
                            $zones = $delivery->zones ?? collect();
                        @endphp

                        @if ($zones->isEmpty())
                            <div class="text-muted">{{ __('No zones assigned to this delivery.') }}</div>
                        @else
                            <div class="d-flex flex-wrap gap-2">
                                @foreach ($zones as $zone)
                                    <a href="{{ route('admin.zones.show', $zone) }}" class="badge bg-gradient-info text-decoration-none px-3 py-2">
                                        #{{ $zone->id }} - {{ $zone->name }}
                                    </a>
                                @endforeach
                            </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 bg-white" style="background: #ffffff !important; border-color: transparent !important;">
                    <div class="card-body" style="background: #ffffff !important;">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route('admin.deliveries.edit', $delivery->id) }}" class="btn btn-warning shadow-sm me-2">
