    ...
    <div class="container-fluid py-4">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">{{ __("Today's Users") }}</p>
                                    <h5 class="font-weight-bolder text-white">
                                        {{ $todaysCustomers }}
                                    </h5>
                                </div>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            ...
                            <div class="col-4 text-end">
                                <div class="icon icon-shape bg-gradient-secondary shadow-dark text-center rounded-circle">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            ...
                            <div class="col-4 text-end">
                                <div
                                    class="icon icon-shape bg-gradient-tertiary shadow-secondary text-center rounded-circle">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide h-100" data-bs-ride="carousel">
                        <div class="carousel-inner border-radius-lg h-100">
                            <div class="carousel-item h-100 active"
                                style="background-image: url('{{ asset('dashboard') }}/img/carousel-1.jpg');
      background-size: cover;">
                            ...
                            <div class="carousel-item h-100"
                                style="background-image: url('{{ asset('dashboard') }}/img/carousel-2.jpg');
      background-size: cover;">
                                <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                            ...
                            <div class="carousel-item h-100"
                                style="background-image: url('{{ asset('dashboard') }}/img/carousel-3.jpg');
      background-size: cover;">
                                <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                    ...
                    <div class="card-header pb-0 p-3">
                        <div class="d-flex justify-content-between">
                            <h6 class="mb-2">
                                ...
                                <br>
                                <small class="text-muted">{{ __('products with stock less than 5 in any branch stock') }}</small>
                            </h6>
                        </div>
                    </div>
                                ...
                                @foreach ($lowStockProducts as $product)
                                    <tr>
                                        ...
                                        <td class="align-middle text-sm">
                                            {{-- show --}}
                                            <div class="col text-center">
                                                <a href="{{ route('admin.products.show', $product->slug) }}" class="text-primary"><i class="fa fa-eye"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div class="card-body p-3">
                        <ul class="list-group">
                            @foreach ($topCustomers as $user)
                                <li
                                    class=" border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <h5 class="mb-1 text-dark text-sm">{{ $user->name }} {{ $user->id }}</h5>
